...
h2_desserts_catalog = Десерти
not_prod_catalog = Товарів поки немає
currency_catalog = грн
measure_unit = гр

#product.html
title_product = Zero Caloriy – низькокалорійні десерти без цукру
...
additional_info_product = КБЖУ (100г)
